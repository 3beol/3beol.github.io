...
function get_taja_hangeul(type) {
  ...
  var K3_3moa_2015 = {
    ...
    '<strong class="cheot">ㄸ[ㄷ,ㅇ]</strong>':  [['i','j'], [7,6], ["key_i","key_j"]],
    '<strong class="cheot">ㄹ</strong>':  ['m', 7, "key_m"],
    '<strong class="cheot">ㅁ</strong>':  ['y', 7, "key_y"],
    '<strong class="cheot">ㅂ</strong>':  ['o', 9, "key_o"],
    '<strong class="cheot">ㅃ[ㅂ,ㅇ]</strong>':  [['j','o'], [6,9], ["key_j","key_o"]],
    '<strong class="cheot">ㅅ</strong>':  ['h', 7, "key_h"],
    '<strong class="cheot">ㅆ[ㅅ,ㅇ]</strong>':  [['h','j'], [6,6], ["key_h","key_j"]],
    '<strong class="cheot">ㅇ</strong>':  ['j', 7, "key_j"],
    '<strong class="cheot">ㅈ</strong>':  ['l', 9, "key_l"],
    '<strong class="cheot">ㅉ[ㅈ,ㅇ]</strong>':  [['j','l'], [6,9], ["key_j","key_l"]],
    '<strong class="cheot">ㅊ[ㅅ,ㅎ]</strong>':  [['h','n'], [6,6], ["key_h","key_n"]],
    '<strong class="cheot">ㅊ[ㅈ,ㅎ]</strong>':  [['l','n'], [9,6], ["key_l","key_n"]],
    '<strong class="cheot">ㅋ[ㄱ,ㅎ]</strong>':  [['k','n'], [8,7], ["key_k","key_n"]],
    '<strong class="cheot">ㅌ[ㄷ,ㅎ]</strong>':  [['i','n'], [7,6], ["key_i","key_n"]],
    '<strong class="cheot">ㅍ[ㅂ,ㅎ]</strong>':  [['n','o'], [6,9], ["key_n","key_o"]],
    ...
    '<strong class="gawit">ㅒ[ㅓ,ㅕ]</strong>': [['r','t'], [2,2], ["key_r","key_t"]],
    '<strong class="gawit">ㅒ[ㅕ,ㅗ]</strong>': [['p','t'], [10,2], ["key_p","key_t"]],
    '<strong class="gawit">ㅑ[ㅓ,ㅗ]</strong>': [['p','r'], [10,2], ["key_p","key_r"]],
    '<strong class="gawit">ㅓ</strong>': ['r', 2, "key_r"],
    '<strong class="gawit">ㅔ</strong>': ['c', 3, "key_c"],
    '<strong class="gawit">ㅕ</strong>': ['t', 2, "key_t"],
    '<strong class="gawit">ㅖ[ㅔ,ㅗ]</strong>': [['c','p'], [3,10], ["key_c","key_p"]],
    '<strong class="gawit">ㅗ</strong>': ['v', 2, "key_v"],
    '<strong class="gawit">ㅘ[ㅏ,ㅗ]</strong>': [['f','p'], [2,10], ["key_f","key_p"]],
    ...
    '<strong class="gawit">ㅚ[ㅣ,ㅗ]</strong>': [['d','p'], [3,10], ["key_d","key_p"]],
    '<strong class="gawit">ㅛ[ㅗ,ㅗ]</strong>': [['p','v'], [10,2], ["key_p","key_v"]],
    '<strong class="gawit">ㅛ[ㅏ,ㅓ]</strong>': [['f','r'], [2,2], ["key_f","key_r"]],
    '<strong class="gawit">ㅜ</strong>': ['b', 2, "key_b"],
    '<strong class="gawit">ㅝ[ㅓ,ㅜ]</strong>': [['\'','r'], [10,2], ["key_apostrophe","key_r"]],
    //'<strong class="gawit">ㅞ[ㅓ,ㅟ]</strong>': [['b','r'], [2,2], ["key_b","key_r"]],
    '<strong class="gawit">ㅞ[ㅔ,ㅜ]</strong>': [['\'','c'], [10,3], ["key_apostrophe","key_c"]],
    //'<strong class="gawit">ㅞ[ㅝ,ㅣ]</strong>': [['b','c'], [2,3], ["key_b","key_c"]],
    '<strong class="gawit">ㅟ[ㅣ,ㅜ]</strong>': [['\'','d'], [10,3], ["key_apostrophe","key_d"]],
    '<strong class="gawit">ㅠ[ㅜ,ㅗ]</strong>': [['b','p'], [2,10], ["key_b","key_p"]],
    '<strong class="gawit">ㅡ</strong>': ['g', 2, "key_g"],
    ...
    '<strong class="ggeut">ㄳ[ㄱ,ㅅ]</strong>': [['q','x'], [5,4], ["key_q","key_x"]],
    '<strong class="ggeut">ㄴ</strong>': ['s', 4, "key_s"],
    '<strong class="ggeut">ㄵ[ㄴ,ㄹ]</strong>': [['e','s'], [3,4], ["key_e","key_s"]],
    // 한 글쇠를 두 번 누르는 것은 되지 않으니 한 번에 넘긴다
    '<strong class="ggeut">ㄶ[ㄴ,ㄴ]</strong>': [['s'], [4], ["key_s"]],
    '<strong class="ggeut">ㄶ[ㄴ,ㅇ]</strong>': [['a','s'], [5,4], ["key_a","key_s"]],
    //'<strong class="ggeut">ㄶ[ㄴ,ㅎ]</strong>': [['a','s'], [5,4], ["key_a","key_s"]],
    '<strong class="ggeut">ㄷ[ㅁ,ㅆ]</strong>': [[';','z'], [10,5], ["key_semicolon","key_z"]],
    '<strong class="ggeut">ㄹ</strong>': ['e', 3, "key_e"],
    '<strong class="ggeut">ㄺ[ㄱ,ㄹ]</strong>': [['e','x'], [3,4], ["key_e","key_x"]],
    '<strong class="ggeut">ㄺ[ㄱ,ㅁ]</strong>': [['x','z'], [4,5], ["key_x","key_z"]],
    ...
    '<strong class="ggeut">ㄾ[ㄹ,ㅇ]</strong>': [['a','e'], [5,3], ["key_a","key_e"]],
    '<strong class="ggeut">ㄿ[ㅂ,ㅇ]</strong>': [['a','w'], [5,4], ["key_a","key_w"]],
    '<strong class="ggeut">ㅀ[ㅇ,ㅆ]</strong>': [[';','a'], [10,5], ["key_semicolon","key_a"]],
    '<strong class="ggeut">ㅁ</strong>': ['z', 5, "key_z"],
    ...
    '<strong class="ggeut">ㅇ</strong>': ['a', 5, "key_a"],
    '<strong class="ggeut">ㅈ[ㄹ,ㅆ]</strong>': [[';','e'], [10,3], ["key_semicolon","key_e"]],
    '<strong class="ggeut">ㅊ[ㅅ,ㅆ]</strong>': [[';','q'], [10,5], ["key_semicolon","key_q"]],
    '<strong class="ggeut">ㅎ[ㄴ,ㅆ]</strong>': [[';','s'], [10,4], ["key_semicolon","key_s"]],
    '<strong class="ggeut">ㅌ[ㄴ,ㅁ]</strong>': [['s','z'], [4,5], ["key_s","key_z"]],
    //'<strong class="ggeut">ㅌ[ㄷ,ㅎ]</strong>': [['s','z'], [4,5], ["key_s","key_z"]],
    '<strong class="ggeut">ㅋ[ㄱ,ㅆ]</strong>': [[';','x'], [10,4], ["key_semicolon","key_x"]],
    //'<strong class="ggeut">ㅋ[ㄱ,ㅎ]</strong>': [[';','x'], [10,4], ["key_semicolon","key_x"]],
    '<strong class="ggeut">ㅍ[ㅂ,ㅆ]</strong>': [[';','w'], [10,4], ["key_semicolon","key_w"]],
